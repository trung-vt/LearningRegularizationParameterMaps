...
% https://tex.stackexchange.com/questions/336673/appendix-is-not-showing
...
We implement the proposed combined model and evaluate it on the Chest X-ray dataset and the Turtle ID 2022 dataset.
...
- Experiment with a larger neural network.
...
% It is proven that if $L \geq \| [\mathbf{I}, \nabla]^\text{T} \|_2$ then the algorithm converges.
...
\begin{textit}
In the code, if we specify a $t$ value then the following transformation is used:
\end{textit}
\begin{equation}
...
% the \codeword{up-bound} parameter to 0 and 
$T_{\text{train}}$ to 256.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.1\linewidth]{../data/turtle_id_2022/turtles-data/data/images/t008/PaXakrkxqN.JPG}
    \includegraphics[width=0.1\linewidth]{../data/turtle_id_2022/turtles-data/data/images/t570/UaEGrKBOme.jpeg}
    \includegraphics[width=0.1\linewidth]{../data/turtle_id_2022/turtles-data/data/images/t101/AiEMbgYfIX.jpg}
    \includegraphics[width=0.1\linewidth]{../data/turtle_id_2022/turtles-data/data/images/t200/AXJrcNfeds.jpg}
    \includegraphics[width=0.1\linewidth]{../data/turtle_id_2022/turtles-data/data/images/t300/cEGpnPZeDI.jpeg}
    \includegraphics[width=0.1\linewidth]{../data/turtle_id_2022/turtles-data/data/images/t400/EAjUlXyTPZ.JPG}
    \includegraphics[width=0.1\linewidth]{../data/turtle_id_2022/turtles-data/data/images/t500/dnoPzYiZii.jpeg}
    \includegraphics[width=0.1\linewidth]{../data/turtle_id_2022/turtles-data/data/images/t600/crnsyTUIyS.jpeg}
    \includegraphics[width=0.1\linewidth]{../data/turtle_id_2022/turtles-data/data/images/t070/AHmeYdbiKe.JPG}

    \includegraphics[width=0.1\linewidth]{../data/turtle_id_2022/turtles-data/data/images/t080/BHfaybcCbL.jpg}
    \includegraphics[width=0.1\linewidth]{../data/turtle_id_2022/turtles-data/data/images/t090/ckWXIjaiUr.JPG}
    \includegraphics[width=0.1\linewidth]{../data/turtle_id_2022/turtles-data/data/images/t102/AGbpwnGLVP.JPG}
    \includegraphics[width=0.1\linewidth]{../data/turtle_id_2022/turtles-data/data/images/t110/adTmyVFBsx.JPG}
    \includegraphics[width=0.1\linewidth]{../data/turtle_id_2022/turtles-data/data/images/t120/pKGKUmGNUu.JPG}
    \includegraphics[width=0.1\linewidth]{../data/turtle_id_2022/turtles-data/data/images/t150/dLEPRooqTG.JPG}
    \includegraphics[width=0.1\linewidth]{../data/turtle_id_2022/turtles-data/data/images/t160/bIeNjNmPqN.JPG}
    \includegraphics[width=0.1\linewidth]{../data/turtle_id_2022/turtles-data/data/images/t170/FzMylIXByx.JPG}
    \includegraphics[width=0.1\linewidth]{../data/turtle_id_2022/turtles-data/data/images/t190/HCFFrEjYfB.JPG}

    \caption{
        Examples of the Turtle ID 2022 dataset.
    }
\end{figure}
...
For the Turtle ID dataset, first we split the dataset into training, validation, and test sub-datasets with ratio 0.8 : 0.1 : 0.1.
...
For the Turtle ID dataset, we also crop the images to squares. Then we rescale the resolution to $512 \times 512$.
...
For the turtle ID dataset, we set up using a different method of adding Gaussian noise. We use the common data-independent Gaussian noise addition
\begin{equation}
...
In my implementation, I used the \codeword{random_noise} function from \codeword{scikit-image} library version \codeword{0.24.0}.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\linewidth]{../data/turtle_id_2022/turtles-data/data/images/t008/PaXakrkxqN.JPG}
    \includegraphics[width=0.3\linewidth]{../data/turtle_id_2022/turtles-data/data/images_crop_resize_512/t008/PaXakrkxqN.JPG}
    \includegraphics[width=0.3\linewidth]{../data/turtle_id_2022/turtles-data/data/images_crop_resize_512_greyscale/t008/PaXakrkxqN.JPG}
    % \includegraphics[width=0.3\linewidth]{../data/turtle_id_2022/turtles-data/data/images_crop_resize_512_greyscale_noisy_0_05/t008/PaXakrkxqN.JPG}
    \includegraphics[width=0.3\linewidth]{../data/turtle_id_2022/turtles-data/data/images_crop_resize_512_greyscale_noisy_0_1/t008/PaXakrkxqN.JPG}
    % \includegraphics[width=0.3\linewidth]{../data/turtle_id_2022/turtles-data/data/images_crop_resize_512_greyscale_noisy_0_15/t008/PaXakrkxqN.JPG}
    \includegraphics[width=0.3\linewidth]{../data/turtle_id_2022/turtles-data/data/images_crop_resize_512_greyscale_noisy_0_2/t008/PaXakrkxqN.JPG}
    % \includegraphics[width=0.3\linewidth]{../data/turtle_id_2022/turtles-data/data/images_crop_resize_512_greyscale_noisy_0_25/t008/PaXakrkxqN.JPG}
    \includegraphics[width=0.3\linewidth]{../data/turtle_id_2022/turtles-data/data/images_crop_resize_512_greyscale_noisy_0_3/t008/PaXakrkxqN.JPG}
...
% More layers can have a regularisation effect.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.34\linewidth]{../turtle_id/test/test_reg_map/06_24_19_56_05-50/test/images_crop_resize_512_greyscale_noisy_0_1/t008/PaXakrkxqN/clean.png}
    \includegraphics[width=0.34\linewidth]{../turtle_id/test/test_reg_map/06_24_19_56_05-50/test/images_crop_resize_512_greyscale_noisy_0_1/t008/PaXakrkxqN/noisy.png}
    \includegraphics[width=0.34\linewidth]{../turtle_id/test/test_reg_map/06_24_19_56_05-50/test/images_crop_resize_512_greyscale_noisy_0_1/t008/PaXakrkxqN/scalar/best_PSNR.png}
    \includegraphics[width=0.34\linewidth]{../turtle_id/test/test_reg_map/06_24_19_56_05-50/test/images_crop_resize_512_greyscale_noisy_0_1/t008/PaXakrkxqN/denoised.png}
    \caption{
        Turtle ID example. 
...
\begin{figure}[H]
    ...
    \caption{
        The produced $\mathbf{\Lambda}_{\Theta}$ map for the Turtle ID dataset example. 
...
\begin{figure}[H]
    ...
    % \includegraphics[width=0.24\linewidth]{../turtle_id/test/test_reg_map/06_24_19_56_05-50/test/images_crop_resize_512_greyscale_noisy_0_05/t008/PaXakrkxqN/noisy.png}
    % \includegraphics[width=0.24\linewidth]{../turtle_id/test/test_reg_map/06_24_19_56_05-50/test/images_crop_resize_512_greyscale_noisy_0_05/t008/PaXakrkxqN/scalar/best_PSNR.png}
    % \includegraphics[width=0.24\linewidth]{../turtle_id/test/test_reg_map/06_24_19_56_05-50/test/images_crop_resize_512_greyscale_noisy_0_05/t008/PaXakrkxqN/denoised.png}
    % \includegraphics[width=0.24\linewidth]{../turtle_id/test/test_reg_map/06_24_19_56_05-50/test/images_crop_resize_512_greyscale_noisy_0_05/t008/PaXakrkxqN/reg_map.png}
    \includegraphics[width=0.24\linewidth]{../turtle_id/test/test_reg_map/06_24_19_56_05-50/test/images_crop_resize_512_greyscale_noisy_0_1/t008/PaXakrkxqN/noisy.png}
    \includegraphics[width=0.24\linewidth]{../turtle_id/test/test_reg_map/06_24_19_56_05-50/test/images_crop_resize_512_greyscale_noisy_0_1/t008/PaXakrkxqN/scalar/best_PSNR.png}
    \includegraphics[width=0.24\linewidth]{../turtle_id/test/test_reg_map/06_24_19_56_05-50/test/images_crop_resize_512_greyscale_noisy_0_1/t008/PaXakrkxqN/denoised.png}
    \includegraphics[width=0.24\linewidth]{../turtle_id/test/test_reg_map/06_24_19_56_05-50/test/images_crop_resize_512_greyscale_noisy_0_1/t008/PaXakrkxqN/reg_map.png}
    % \includegraphics[width=0.24\linewidth]{../turtle_id/test/test_reg_map/06_24_19_56_05-50/test/images_crop_resize_512_greyscale_noisy_0_15/t008/PaXakrkxqN/noisy.png}
    % \includegraphics[width=0.24\linewidth]{../turtle_id/test/test_reg_map/06_24_19_56_05-50/test/images_crop_resize_512_greyscale_noisy_0_15/t008/PaXakrkxqN/scalar/best_PSNR.png}
    % \includegraphics[width=0.24\linewidth]{../turtle_id/test/test_reg_map/06_24_19_56_05-50/test/images_crop_resize_512_greyscale_noisy_0_15/t008/PaXakrkxqN/denoised.png}
    % \includegraphics[width=0.24\linewidth]{../turtle_id/test/test_reg_map/06_24_19_56_05-50/test/images_crop_resize_512_greyscale_noisy_0_15/t008/PaXakrkxqN/reg_map.png}
    \includegraphics[width=0.24\linewidth]{../turtle_id/test/test_reg_map/06_24_19_56_05-50/test/images_crop_resize_512_greyscale_noisy_0_2/t008/PaXakrkxqN/noisy.png}
    \includegraphics[width=0.24\linewidth]{../turtle_id/test/test_reg_map/06_24_19_56_05-50/test/images_crop_resize_512_greyscale_noisy_0_2/t008/PaXakrkxqN/scalar/best_PSNR.png}
    \includegraphics[width=0.24\linewidth]{../turtle_id/test/test_reg_map/06_24_19_56_05-50/test/images_crop_resize_512_greyscale_noisy_0_2/t008/PaXakrkxqN/denoised.png}
    \includegraphics[width=0.24\linewidth]{../turtle_id/test/test_reg_map/06_24_19_56_05-50/test/images_crop_resize_512_greyscale_noisy_0_2/t008/PaXakrkxqN/reg_map.png}
    % \includegraphics[width=0.24\linewidth]{../turtle_id/test/test_reg_map/06_24_19_56_05-50/test/images_crop_resize_512_greyscale_noisy_0_25/t008/PaXakrkxqN/noisy.png}
    % \includegraphics[width=0.24\linewidth]{../turtle_id/test/test_reg_map/06_24_19_56_05-50/test/images_crop_resize_512_greyscale_noisy_0_25/t008/PaXakrkxqN/scalar/best_PSNR.png}
    % \includegraphics[width=0.24\linewidth]{../turtle_id/test/test_reg_map/06_24_19_56_05-50/test/images_crop_resize_512_greyscale_noisy_0_25/t008/PaXakrkxqN/denoised.png}
    % \includegraphics[width=0.24\linewidth]{../turtle_id/test/test_reg_map/06_24_19_56_05-50/test/images_crop_resize_512_greyscale_noisy_0_25/t008/PaXakrkxqN/reg_map.png}
    \includegraphics[width=0.24\linewidth]{../turtle_id/test/test_reg_map/06_24_19_56_05-50/test/images_crop_resize_512_greyscale_noisy_0_3/t008/PaXakrkxqN/noisy.png}
    \includegraphics[width=0.24\linewidth]{../turtle_id/test/test_reg_map/06_24_19_56_05-50/test/images_crop_resize_512_greyscale_noisy_0_3/t008/PaXakrkxqN/scalar/best_PSNR.png}
    \includegraphics[width=0.24\linewidth]{../turtle_id/test/test_reg_map/06_24_19_56_05-50/test/images_crop_resize_512_greyscale_noisy_0_3/t008/PaXakrkxqN/denoised.png}
    \includegraphics[width=0.24\linewidth]{../turtle_id/test/test_reg_map/06_24_19_56_05-50/test/images_crop_resize_512_greyscale_noisy_0_3/t008/PaXakrkxqN/reg_map.png}
...
Through experiments with the Chest X-ray dataset and the Turtle ID 2022 dataset, we demonstrate that using U-Net to produce a regularisation parameter map $\mathbf{\Lambda}_{\Theta}$ enhances the denoising performance of the total variation method compared to the traditional scalar $\lambda$.
...
% \chapter{Deriving the Dual Problem}
