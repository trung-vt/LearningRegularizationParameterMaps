...
- the Chest X-Ray Images (Pneumonia) dataset which was downloaded from \cite{kermany2018large} and 

- the Turtle ID data set \cite{Adam_2024_WACV}.
...
For the turtle ID dataset, we use the common data-independent Gaussian noise addition
\begin{equation}
...
For the turtle ID dataset, I setup using a different method of adding Gaussian noise.
...
\begin{figure}
    ...
    \includegraphics[width=0.3\linewidth]{../data/turtle_id_2022/turtles-data/data/images_crop_resize_256/t008/PaXakrkxqN.JPG}
    \includegraphics[width=0.3\linewidth]{../data/turtle_id_2022/turtles-data/data/images_crop_resize_256_greyscale/t008/PaXakrkxqN.JPG}
    \includegraphics[width=0.3\linewidth]{../data/turtle_id_2022/turtles-data/data/images_crop_resize_256_greyscale_noisy_0_05/t008/PaXakrkxqN.JPG}
    \includegraphics[width=0.3\linewidth]{../data/turtle_id_2022/turtles-data/data/images_crop_resize_256_greyscale_noisy_0_1/t008/PaXakrkxqN.JPG}
    \includegraphics[width=0.3\linewidth]{../data/turtle_id_2022/turtles-data/data/images_crop_resize_256_greyscale_noisy_0_15/t008/PaXakrkxqN.JPG}
    \includegraphics[width=0.3\linewidth]{../data/turtle_id_2022/turtles-data/data/images_crop_resize_256_greyscale_noisy_0_2/t008/PaXakrkxqN.JPG}
    \includegraphics[width=0.3\linewidth]{../data/turtle_id_2022/turtles-data/data/images_crop_resize_256_greyscale_noisy_0_25/t008/PaXakrkxqN.JPG}
    \includegraphics[width=0.3\linewidth]{../data/turtle_id_2022/turtles-data/data/images_crop_resize_256_greyscale_noisy_0_3/t008/PaXakrkxqN.JPG}
...
\subsubsection{Chest X-ray Dataset}
