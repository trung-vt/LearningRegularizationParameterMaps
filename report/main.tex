...
\begin{figure}[H]
    ...
    \caption{
        Turtle ID example. 
        The top row shows the original image on the left and the noisy image, generated with Gaussian noise with $\sigma = 0.05$. 
        The bottom row shows the denoised images using the TV method; 
        the left image with PSNR = ... was produced 
        using the best scalar regularisation parameter $\lambda = ...$ , 
        while the right image with PSNR = \textbf{...} was denoised 
