...
\begin{tabular}{|c|c|c|}
\hline
 & \textbf{PDHG -} $\lambda$ & \textbf{PDHG -} $\Lambda$ \\
\hline
\textbf{PSNR} & $33.43 \pm 2.16$ & $34.73 \pm 2.02$ \\
\textbf{SSIM} & $0.87 \pm 0.04$ & $0.90 \pm 0.03$ \\
\hline
\end{tabular}
\caption{Scalar $\lambda$ and $\Lambda$ map values}
\label{table:1}
\end{table}
