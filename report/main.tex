...
We calculate the gradient in the horizontal and vertical directions separately, and then combine them to get the total variation of the image. The following is the formula for the forward gradient:
