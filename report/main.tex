...
% \begin{figure}[h]
%         \centering
%         \includegraphics[width=1\linewidth]{100-denoised_compare.png}
%         \caption{SIDD example}
%         \label{fig:enter-label}
%     \end{figure}
...
\begin{figure}[h]
    \centering
%     \includegraphics[width=0.6\linewidth]{images//chest_xray/output.png}
% \begin{figure}
%         \centering
...
% \begin{figure}[h]
%     \centering
%     \includegraphics[width=0.5\linewidth]{images//chest_xray/box.png}
%     \caption{Chest X-ray box plots}
%     \label{fig:enter-label}
% \end{figure}
